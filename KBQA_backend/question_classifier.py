...
class QuestionClassifier:
    def __init__(self):
        ...
        #　特征词路径
        self.person_path = os.path.join(cur_dir, '/KBQA_backend/person.txt')
        self.movie_path = os.path.join(cur_dir, '/KBQA_backend/movie.txt')
        self.genre_path = os.path.join(cur_dir, '/KBQA_backend/genre.txt')
